...
3. **[User management](/deploy/user-management)** — create the first admin, invite teammates, set up Google OAuth, mint personal access tokens
4. **[MCP servers](/deploy/mcp-servers)** — register the tools (Notion, HubSpot, BigQuery, …) you want agents to use
5. **[Sandbox](/deploy/sandbox)** — run OpenSandbox if you want agents to execute code
