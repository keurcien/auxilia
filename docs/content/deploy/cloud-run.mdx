...
If you want agents to run code, Cloud Run is also the easiest place to host the sandbox runtime: deploy the `sandbox-gateway` service and set `SANDBOX_PROVIDER=cloudrun` on the backend. See [Cloud Run Sandboxes](/deploy/sandbox/cloud-run).
