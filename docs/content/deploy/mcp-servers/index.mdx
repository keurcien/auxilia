...
1. **Set up an official server** — a pre-configured server from the [official catalog](/deploy/mcp-servers/catalog) (Notion, Linear, GitHub, Sentry, Stripe, HubSpot, BigQuery, …). Click **Install** and, if required, supply OAuth client credentials.
