...
- [HubSpot](/deploy/mcp-servers/examples/hubspot)
- [GitHub](/deploy/mcp-servers/examples/github)
- [BigQuery](/deploy/mcp-servers/examples/bigquery)

## Custom MCP servers

You can add any remote MCP server by URL. Click **Add MCP server**, then **Add a custom server**, and fill in:
