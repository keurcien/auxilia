...
1. Click **Add MCP server** and find **GitHub** in the catalog
2. Click **Add**
...
2. Click **Add tool** → **GitHub**
3. Set [tool permissions](/agents/tools) — PR / issue creation and commit-writing tools are good candidates for **needs approval**
...
3. Copy the token
4. In **auxilia**, **Add MCP server** → **Add a custom server**, auth type **API key**, URL `https://api.githubcopilot.com/mcp`, token pasted into the **API key** field
