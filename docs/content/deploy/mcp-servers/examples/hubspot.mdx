...
1. Click **Add MCP server** and find **HubSpot** in the catalog
2. Click **Add**
3. Enter:
...
2. Click **Add tool** and pick **HubSpot**
3. Configure [tool settings](/agents/tools) — for HubSpot, write tools are a good candidate for **needs approval**
