...
1. Go to **MCP Servers** → **Add MCP server** and find **BigQuery** in the catalog
2. Click **Add**
...
2. **Add tool** → **BigQuery**
3. Configure [tool settings](/agents/tools) — `execute_sql_readonly` is safe to auto-approve; `execute_sql` (write) is a good candidate for **needs approval**
