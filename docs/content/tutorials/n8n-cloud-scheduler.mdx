...
Both use the same underlying mechanism — a simple HTTP request — so if you haven't already, skim **[Trigger agents over HTTP](/tutorials/http-invoke)** first to understand the shape of the call.
