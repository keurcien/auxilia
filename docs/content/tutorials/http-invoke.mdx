...
See **[Use auxilia from n8n & Cloud Scheduler](/tutorials/n8n-cloud-scheduler)** for a step-by-step for each of those.
...
If you'd rather have the automation run end-to-end without pauses, review the agent's [tool settings](/agents/tools) and switch the relevant tools to **always allow**.
