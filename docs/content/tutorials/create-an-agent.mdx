...
Save your instructions. Changes take effect on the next message; existing chat threads aren't recomputed. See [Configuration](/agents/configuration) for more prompt-writing tips.
...
- **[Share it with your workspace](/agents/permissions)** — grant teammates `user`, `editor`, or `admin` access
...
- **[Run it on a schedule](/tutorials/n8n-cloud-scheduler)** — daily digests and recurring reports
- **[Add subagents](/agents/subagents)** or the **[sandbox](/agents/sandbox)** for more advanced agents
