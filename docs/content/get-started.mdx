...
# Code-execution sandbox (see /docs/agents/sandbox)
...
# Langfuse observability (see /docs/deploy/langfuse)
...
See [MCP Servers](/docs/deploy/mcp-servers) for the full registration flow and auth options.
...
- **[Build Agents](/docs/agents)** — configuration, tools & permissions, subagents, sandbox
- **[Deploy & Configure](/docs/deploy)** — move from local to production, add user management, MCP servers, Slack, Langfuse
- **[Tutorials](/docs/tutorials)** — trigger agents from Slack, from HTTP, from schedulers, or inside a custom UI
