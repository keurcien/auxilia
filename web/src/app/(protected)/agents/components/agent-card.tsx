...
export default function AgentCard({ agent }: AgentCardProps) {
	...
	return (
		<div
			className="group flex flex-col p-5 bg-card border border-border rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer h-full"
		...
		>
			<div className="flex items-start gap-4 mb-3">
				...
				<div className="flex flex-col overflow-hidden">
					<h2 className="text-base font-bold text-card-foreground leading-tight truncate w-full">
						{agent.name}
					</h2>
