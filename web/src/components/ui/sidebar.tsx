...
// group pad = 54px interior + the 1px right border = 55px. The width is
// border-box on the bordered container, so the border must be counted or
// the rows lose 1px of right margin and sit off-center.
