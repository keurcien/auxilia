...
| `router.py`     | HTTP surface (create / invoke / get / cancel / list / active); live streaming is `app/runtime/protocol/` |
...
(`POST /threads/{id}/stream/events`, `app/runtime/api/service.py`) relays
