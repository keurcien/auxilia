...
def build_agent(
    *,
    ...
    from app.runtime.agent import build_parent_middleware
...
def in_memory_runtime():
    ...
    with (
        patch("app.runtime.agent.get_checkpointer", fake_checkpointer),
...
def build_sandbox_agent(
    *, script: list, tools: list | None = None, skills=(), sandbox_id=None
    ...
    """
    from app.runtime.agent import ResolvedSandbox, build_parent_middleware
