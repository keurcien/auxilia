...
import app.runtime.api.protocol_service as service_mod
from app.exceptions import DomainValidationError, NotFoundError
from app.runtime.api.protocol_schemas import ProtocolCommand
...
def _route_fake_checkpointers(monkeypatch):
    ...
    from app.runtime.api import protocol_service as service_mod
