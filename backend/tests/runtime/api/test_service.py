...
def _route_fake_checkpointers(monkeypatch):
    ...
    from app.runtime.api import service as service_mod
...
async def test_history_without_a_tools_namespace_is_empty(monkeypatch):
    monkeypatch.setattr(
        "app.runtime.api.service.get_checkpointer",
...
async def test_history_resolves_a_task_call_to_its_subgraph_checkpoint(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.runtime.api.service.get_checkpointer", _checkpointer_cm(checkpointer)
    )
