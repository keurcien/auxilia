"""HITL checkpoint reading + resume-command canonicalization (`app/runtime/hitl.py`)."""
...
from app.runtime.checkpoints import EMPTY_STATE, get_checkpoint_state
...
async def test_load_interrupt_scope_descent_is_bounded():
    ...
    from app.runtime.hitl import MAX_SUBAGENT_DEPTH
